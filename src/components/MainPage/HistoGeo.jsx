...
export default function HistoGeo({ selectedDistrict, setSelectedDistrict }) {
    ...
    return (
        <div className={`histogram-container w-full h-[400px] pb-7 pt-2 bg-gray-100 rounded-xl transition-all duration-500 hover:scale-105 hover:shadow-2xl border border-gray/20 cursor-pointer`}>
